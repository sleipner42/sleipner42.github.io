...
När du själv väljer en skola och klass kontaktar appen Skola24s centrala webbtjänst (web.skola24.se). Förfrågningar innehåller vald Skola24-värd, skolans och klassens tekniska identifierare samt begärd vecka och uppgifter som behövs för hämtningen. Skola24 tar också emot vanlig anslutningsinformation, såsom IP-adress och appens klientbeteckning. Appen tar emot skolor, klasser, lektionstider och schematexter, exempelvis ämnen, lärare och salar. Schemat hålls i appens arbetsminne. Ett offentligt schema kan innehålla personuppgifter. Om du tidigare har valt en klass hämtar appen det klasschemat när appen startar.

### Sparat klassval

När du väljer en klass sparas skolans värdnamn och tekniska identifierare för skola och klass i en liten fil på enheten. Filen innehåller inte klassens visningsnamn, lektionsinnehåll, lärares namn, Schema-ID, elev-ID, personnummer eller lösenord. Valet finns kvar mellan appstarter tills du ersätter eller tar bort det. Vid nästa start använder appen valet för att hämta klasschemat; hela veckoschemat sparas inte för offlinevisning. Välj Byt skola eller klass för att ersätta valet. Appen visar fel om lagringen eller raderingen inte lyckas. Detta raderar inte uppgifter hos skolan eller Skola24. Filen ligger i appens dokumentområde och är inte undantagen från enhetsbackup. Tidigare säkerhetskopior hanteras separat från appens radering.

### Schema-ID eller elev-ID

Om den valda skolan stöder det kan du ange ett Schema-ID eller elev-ID. ID:t skickas till Skola24 för att hämta schemat för den aktuella sessionen. Appen behåller ID:t tillfälligt i arbetsminnet så att du kan byta vecka eller uppdatera schemat, men sparar det inte i filen med klassval och återställer det inte nästa gång appen startar. När du väljer ett annat schema ersätts ID-valet. Det återställs inte efter en omstart av appen. Ange inte lösenord, BankID-uppgifter eller personnummer i fältet.
